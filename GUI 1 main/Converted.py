...
board = pyfirmata.Arduino('COM4')  # Replace 'COM10' with the appropriate port for your Arduino
...
analog_input_0 = board.get_pin('a:0:i')
analog_input_1 = board.get_pin('a:1:i')
analog_input_2 = board.get_pin('a:2:i')
