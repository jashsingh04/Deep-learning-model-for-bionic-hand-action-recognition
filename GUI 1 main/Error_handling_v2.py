...
click_action.set("Open")  # Set the default action to "Open"
selected_action = click_action

# Button for toggling between "Open" and "Close"
Action_button = Button(root, textvariable=click_action, height=4, width=18)
Action_button.place(x=8, y=60)
